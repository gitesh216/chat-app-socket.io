...
import type { FormEvent, KeyboardEvent, ChangeEvent, JSX } from 'react';
...
export default function App(): JSX.Element {
    ...
    useEffect(() => {
        ...
        socket.current.on('connect', () => {
            socket.current?.on('roomNotice', (userName: string) => {
                ...
                alert(`${userName} joined to group!`);
            });
    ...
    function handleNameSubmit(e: FormEvent<HTMLFormElement>): void {
        e.preventDefault();
